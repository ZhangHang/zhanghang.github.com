var hint = new Array(
	1,2,3,3,2,2,2,3,3,2,1,1,2,3,4,3,4,3,4,4,3,2,1,2,4,5,4,5,4,5,5,4,3,0,1,2,3,2,4,3,3,3,3,3,1,2,3,2,1,3,3,3,3,3,3,2,4,5,4,2,4,4,5,5,4,3,2,3,4,3,2,3,3,4,4,3,2);
...
function check()
{
	...
	if (winFlag)
		document.getElementById("birthday").innerHTML = "生日快乐！";
	else
